...
<nav class="port-nav">
  <div></div>
  <div class="nav-meta">Dashboard Ejecutivo &middot; Portafolio P&amp;S<br>Actualizado: <span>{CORTE_LABEL}</span> &middot; Elaborado por: Mtro. Alan Cerón C.</div>
</nav>
<main>
  <div class="page-header">
    <div>
      <div class="page-title">Portafolio de Proyectos y Servicios</div>
      <div class="page-sub">CEN Systems S.A. de C.V. &nbsp;&middot;&nbsp; Análisis financiero año por año &nbsp;&middot;&nbsp; Valores en MXN (millones)</div>
    </div>
    <div class="yr-tabs">
