...
<style>
{HUB_NAV_CSS}
:root{{--green:#97D700;--bg:#f4f6fb;--surface:#ffffff;--border:rgba(151,215,0,0.25);--border-sub:#e2e8f0;--text:#1e293b;--text2:#64748b;--text3:#94a3b8;--danger:#dc2626;--warning:#d97706;--info:#2563eb;--r-sm:6px;--r-md:10px;--r-lg:16px;}}
...
nav.port-nav{{display:flex;align-items:center;justify-content:space-between;padding:0 32px;height:48px;background:#fff;border-bottom:1px solid var(--border-sub);}}
.nav-meta{{font-size:12px;color:var(--text3);text-align:right;line-height:1.5;}}
.nav-meta span{{color:var(--green);font-weight:600;}}
