...
.pmo-nav-links a.active{background:rgba(151,215,0,.2);color:#fff;font-weight:600;}
...
<style>
{HUB_NAV_CSS}
:root{{--navy:#101820;--navy-mid:#101820;--teal:#97D700;--ice:#CADCFC;--green:#97D700;--bg:#F5F5F5;--surface:#ffffff;--border:rgba(151,215,0,0.25);--border-sub:#E2E8F0;--text:#101820;--text2:#717C7D;--text3:#919D9D;--danger:#dc2626;--warning:#d97706;--info:#2563eb;--r-sm:6px;--r-md:10px;--r-lg:16px;}}
*{{box-sizing:border-box;margin:0;padding:0;}}
body{{font-family:'Avenir','Open Sans',system-ui,sans-serif;background:var(--bg);color:var(--text);min-height:100vh;font-size:14px;line-height:1.6;}}
.hero{{background:#101820;padding:3rem 2rem 2.5rem;position:relative;border-bottom:4px solid #97D700;}}
...
.yr-btn{{font-family:'Avenir','Open Sans',system-ui,sans-serif;font-size:13px;font-weight:500;padding:7px 22px;border:none;border-radius:var(--r-sm);background:transparent;color:var(--text3);cursor:pointer;transition:all .2s;}}
...
.expand-btn{{font-family:'Avenir','Open Sans',system-ui,sans-serif;font-size:11px;padding:4px 12px;border:1px solid var(--border-sub);border-radius:var(--r-sm);background:transparent;color:var(--text3);cursor:pointer;transition:all .15s;}}
